...
int help() //help
{
	// this is main, without it, you can't even run your app, its like a USER MANUAL 
	
	cout << "How to use the TODO APP :-" << endl;
...
int report() //status
{
	...
	cout << year << "-" << month<< "-" << date<< " " << "Pending Task : " << pending << "Completed Tasks : " << done << endl;
